 ...
 *  화면의 체력바가 갱신된다. 같은 UCPHorizonGuageBarWidget 상속 WBP를 월드/뷰포트 양쪽에서 재사용 가능
 */
...
protected:
	...
	/** UCPHorizonGuageBarWidget을 상속하는 Widget Blueprint (예: WBP_HealthBar) */
	UPROPERTY(EditAnywhere, Category="Health Bar")
	TSubclassOf<UCPHorizonGuageBarWidget> WidgetClass;
